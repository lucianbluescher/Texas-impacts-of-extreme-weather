...
# Check which homes intersect the combined blackout area and subset intersected homes based on boolean
blackout_homes <- homes_sf[lengths(st_intersects(homes_sf, blackout_dif)) > 0, ]
